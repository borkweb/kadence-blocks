                ...
                if (fields[index].label && fields[index].label.includes('{privacy_policy}')) {
                    ...
                    acceptLabel = (
                        <Fragment>
                            ...
                            target="blank"
                            rel="noopener noreferrer">{(undefined !== kadence_blocks_params.privacy_title && '' !== kadence_blocks_params.privacy_title ? kadence_blocks_params.privacy_title : 'Privacy policy')}</a>{acceptLabelAfter}
                        </Fragment>
                    );
                } else {
                    acceptLabel = fields[index].label;
                    ...
                    <div className={fieldClassName}>
                            ...
                            <Fragment>
                                {fields[index].showLink && (
                                    <a href={(undefined !== fields[index].default && '' !== fields[index].default ? fields[index].default : '#')}
                                       ...
                                       className={'kb-accept-link'}>{(undefined !== fields[index].placeholder && '' !== fields[index].placeholder ? fields[index].placeholder : 'View Privacy Policy')}</a>
                                )}
                                {undefined !== fields[index].ariaLabel && fields[index].ariaLabel && (
                                    <span id={`kb_field_desc_${uniqueID}_${index}`}
                                          className="screen-reader-text kb-field-desc-label">{fields[index].ariaLabel}</span>
                                )}
                                <input type="checkbox" name={`kb_field_${index}`} id={`kb_field_${uniqueID}_${index}`}
                                       className={`kb-field kb-checkbox-style kb-${fields[index].type}`}
                                       value={'accept'} checked={fields[index].inline ? true : false}
                                ...
                                <label
                                    htmlFor={`kb_field_${uniqueID}_${index}`}>{(fields[index].label ? acceptLabel : '')}{(fields[index].required && style[0].showRequired ?
                        ...
                        {'accept' !== fields[index].type && (
                            <Fragment>
                                {fields[index].showLabel && (
                                    <label
                                        htmlFor={`kb_field_${uniqueID}_${index}`}>{(fields[index].label ? fields[index].label : '')}{(fields[index].required && style[0].showRequired ?
                                        <span className="required">*</span> : '')}</label>
                                )}
                                {undefined !== fields[index].ariaLabel && fields[index].ariaLabel && (
                                    <span id={`kb_field_desc_${uniqueID}_${index}`}
                                          className="screen-reader-text">{fields[index].ariaLabel}</span>
                                )}
                                {'textarea' === fields[index].type && (
                                    <textarea name={`kb_field_${index}`} id={`kb_field_${uniqueID}_${index}`}
                                              data-label={fields[index].label} type={fields[index].type}
                                              placeholder={fields[index].placeholder} value={fields[index].default}
                                              data-type={fields[index].type}
                                ...
                                {'select' === fields[index].type && (
                                    <select
                                        ...
                                        data-label={fields[index].label} type={fields[index].type}
                                        value={fields[index].default} data-type={fields[index].type}
                                ...
                                {'checkbox' === fields[index].type && (
                                    <div data-type={fields[index].type} data-label={fields[index].label}
                                         id={`kb_field_${uniqueID}_${index}`}
                                         ...
                                         data-validation-message={fields[index].errorMessage ? fields[index].errorMessage : undefined}>
                                        {times(fields[index].options.length, n => (
                                            <div key={n} data-type={fields[index].type}
                                                 className={`kb-checkbox-item kb-checkbox-item-${n}`}>
                                                <input type="checkbox" name={`kb_field_${index}[]`}
                                                ...
                                                <label
                                                    htmlFor={`kb_field_${index}_${n}`}>{(undefined !== fields[index].options[n].label ? fields[index].options[n].label : '')}</label>
                                            </div>
                                        ))}
                                    </div>
                                )}
                                    ...
                                    <div data-type={fields[index].type} data-label={fields[index].label}
                                        ...
                                        {times(fields[index].options.length, n => (
                                            <div key={n} data-type={fields[index].type}
                                                ...
                                                <input type="radio" name={`kb_field_${index}[]`}
                                                       id={`kb_field_${index}_${n}`}
                                ...
                                {'textarea' !== fields[index].type && 'select' !== fields[index].type && 'checkbox' !== fields[index].type && 'radio' !== fields[index].type && (
                                    <input name={`kb_field_${index}`} id={`kb_field_${uniqueID}_${index}`}
                                           data-label={fields[index].label} type={fields[index].type}
                                           placeholder={fields[index].placeholder} value={fields[index].default}
                                           data-type={fields[index].type}
                                           className={`kb-field kb-text-style-field kb-${fields[index].type}-field kb-field-${index}`}
                        ...
                        {undefined !== fields[index].description && '' !== fields[index].description && (
                            <span
                                className={'kb-field-help'}>{(fields[index].description ? fields[index].description : '')}</span>
                        )}
                    </div>
                );
            };
                        ...
                        {recaptcha && (
                            <Fragment>
                                {recaptchaVersion === 'v2' && (
                                    <div className="kadence-blocks-form-field google-recaptcha-checkout-wrap">
                                        <p id="kb-container-g-recaptcha" className="google-recaptcha-container">
										<span id={`kb_recaptcha_${uniqueID}`}
                        ...
                        <div className={submitClassName}>
                            {submitLabel && (
                                <span id={`kb_submit_label_${uniqueID}`}
                                      className="screen-reader-text kb-submit-desc-label">{submitLabel}</span>
                            )}
                            <RichText.Content
                                tagName="button"
